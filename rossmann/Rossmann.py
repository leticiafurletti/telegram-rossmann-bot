...
class Rossmann(object):
    def __init__(self):
        self.home_path=''
        self.competition_time_month_scaler = pickle.load(open('parameter/competition_distance_scaler.pkl', 'rb'))
    ...
    def data_preparation(self, df):
        ...
        df['competition_time_month'] = self.competition_distance_scaler.transform(df[['competition_time_month']].values)
